	...
	<nav class="navbar navbar-expand-lg px-4">
	    ...
	    <div class="collapse navbar-collapse" id="navMenu">
	        <ul class="navbar-nav ms-auto">
	            <li class="nav-item"><a class="nav-link" href="addFeedback.jsp"><span class="fw-bold text-primary">Penguin.lk</span></a></li>
	        </ul>
	    </div>
	</nav>
	<div class="container mt-4">
  
    <form action="addAnswer" method="post" onsubmit="return confirm('Are you sure you want to submit answers?');">
      ...
      <c:set var="e" value="${exam}" />

      <!-- Question 1 -->
      <div class="question-box">
        <div class="question-label">Question 1</div>
        <div class="mark-note">marked out of 5.00</div>
        <input type="text" class="form-control1" name="question1" value="${e.question1}" readonly/>
      ...
      <div class="question-box">
        ...
        <div class="mark-note">marked out of 5.00</div>
        <input type="text" class="form-control1" name="question2" value="${e.question2}" readonly/>
      ...
      <div class="question-box">
        ...
        <div class="mark-note">marked out of 5.00</div>
        <input type="text" class="form-control1" name="question3" value="${e.question3}" readonly/>
      ...
      <div class="question-box">
        ...
        <div class="mark-note">marked out of 5.00</div>
        <input type="text" class="form-control1" name="question4" value="${e.question4}" readonly/>
      ...
      <div class="question-box">
        ...
        <div class="mark-note">marked out of 5.00</div>
        <input type="text" class="form-control1" name="question5" value="${e.question5}" readonly/>
